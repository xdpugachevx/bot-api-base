...
class GetUpdatesNormalizer implements NormalizerInterface
{
    /**
    ...
    public function normalize($topic, $format = null, array $context = [])
    {
        ...
        $topic->allowedUpdates = \json_encode($topic->allowedUpdates);
    ...
    {
        return $data instanceof GetUpdatesMethod;
    }
}
